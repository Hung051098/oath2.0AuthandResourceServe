...
import com.laurentiuspilca.jwtauthserver.service.DefaultAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public void globalConfigAuthenProvider(AuthenticationManagerBuilder auth) {
